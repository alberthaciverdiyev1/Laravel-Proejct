        ...
        <div class="container">
            <div class="section-title text-center">
                ...
                <div class="company-text">
                     <a href="#" style="  background: red; color: white; padding: 10px 20px;display: inline-block;font-size: 14px; margin-right: 10px">
                        Jobs
                    </a>
                    <a href="#" style="  background: red; color: white; padding: 10px 20px;display: inline-block;font-size: 14px;">
                        Services
                    </a>
                </div>
            </div>
